...
export { LocationProvider, Router, Route, useLocation, useRoute } from "preact-iso";
...
export function buildUrl(spec: string | null, view: ViewType, params: UrlParams = {}): string {
