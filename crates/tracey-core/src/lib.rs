...
pub use spec::{
    ...
    RenderedSection, ReqDefinition, SPEC_EXTENSIONS, SlugAllocator, SpecBackend, SpecConfigs,
    SpecDoc, SpecFormat, TypstConfig, diff_inline, extract_marker_prefix, id_range_in_marker,
    is_spec_extension, parse_spec, parse_weight, render_spec_html, render_spec_inline,
    req_anchor_id, req_anchor_to_id, rewrite_marker,
};
